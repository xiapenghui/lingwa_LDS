...
import {
  ...
  addPost,
  updatePut,
} from '@/services/time/timeT5';

const timeT5Component = ({
  timeT5,
  dispatch
}) => {
  const {
  ...
  const getColumns = () => [

    {
      ...
      width: 150,
      hideInSearch: true,
      initialValue: IsUpdate ? UpdateDate.type : 'T5',
...

    {
      ...
      // initialValue: IsUpdate ? UpdateDate.employeeid.toString() : '',
...
export default connect(({ timeT5 }) => ({ timeT5 }))(timeT5Component);
